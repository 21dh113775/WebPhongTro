...
namespace ShopPlantProject.Helpper
{
    public static class Utilities
    {
        ...
        public static bool UploadImages(IFormFile file)
        {
            try
            {
                var path = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot/hinhanhphong");
